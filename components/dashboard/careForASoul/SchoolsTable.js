...
import CareStudentsTable from "../schoolDatabases/CareStudentsTable";
        ...
        <div>
          <div className="flex justify-start ml-24 gap-8 items-center mb-4">
            <button
              ...
              className="flex items-center gap-2 bg-green-500 rounded-sm p-2 text-xl text-white font-bold"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <CareStudentsTable schoolName={selectedSchool.name} searchQuery={searchQuery} />
        </div>
      )}
    </div>
  );
